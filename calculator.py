...
def button_click(number):
  #e.delete(0, END)
  current = e.get()
  e.delete(0, END)#remove entring from behind.
  e.insert(0, str(current) + str(number))

#click to clear a number
def button_clear():
  e.delete(0, END)


#click to perform addition
def button_add():
  first_number = e.get()
  global f_num#So that it can be used anywhere
  global math
  math = "addition"
  f_num = int(first_number)
  e.delete(0, END)

#click to perform subtraction
...
#click to perform multiplication
